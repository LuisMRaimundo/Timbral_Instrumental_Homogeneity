# Timbral_Instrumental_Homogeneity — installers

**Repository:** https://github.com/LuisMRaimundo/Timbral_Instrumental_Homogeneity

This folder contains scripts to install **Timbral_Instrumental_Homogeneity** for users **without prior Python setup**. Open the folder for your operating system:
...
2. Fetches source from **https://github.com/LuisMRaimundo/Timbral_Instrumental_Homogeneity** (`main` branch).
...
Folders `runtime/`, `build/`, `dist/`, `output/`, and compiled `.exe` / `.zip` / `.dmg` / `.tar.gz` artefacts are **not** committed. To distribute ready-made binaries, use [GitHub Releases](https://github.com/LuisMRaimundo/Timbral_Instrumental_Homogeneity/releases).
