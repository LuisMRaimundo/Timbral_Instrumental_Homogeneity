...
| Analyzers | `homogeneity_analyser/analyzers/` | **H_TI** / **`H_TI_core`** (`hti.py`), shared **`timbral.py`** event pipeline. Optional symbolic-blend / **H_TA** proxy — see **`docs/SYMBOLIC_INTERVAL_CLASS_LAYER.md`**, **`docs/H_TA_ACOUSTIC_PROXY.md`**. |
